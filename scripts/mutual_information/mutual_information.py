...
# are duplicated verbatim in scripts/pearson_matrix/pearson_matrix.py. Each script
# folder is self-contained (isolated namespace), so the copies are intentional —
